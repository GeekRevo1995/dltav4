! function (c) {
  if ('object' == typeof exports && 'undefined' != typeof module) module.exports = c();
    ...
    ('undefined' != typeof window ? window : 'undefined' != typeof global ? global : 'undefined' != typeof self ? self : this).buffer = c();
  }
}(function () {
  return function () {
      ...
      ((function (q) {
        ...
        q.prototype.write = function (ar, as, at, au) {
          if (undefined === as) {
            ...
            at = this.length;
            as = 0;
          } else if (undefined === at && 'string' == typeof as) {
            au = as;
            at = this.length;
            as = 0;
          } else {
